...
const {getuser, checkauth, additemtocart, getorderhistory, buyproduct, removeitemfromcart, getAllCartItem, updatestatus, cancelorder, addreviews, getreviews} = require('../controllers/private');
...
router.route("/getreviews").post(protect, getreviews)
